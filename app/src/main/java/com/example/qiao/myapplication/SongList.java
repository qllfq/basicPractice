...
//         设置点击事件
    ...
    public void initlayout() {
        ...
        intent = new Intent(SongList.this, AudioService.class);
        mAdpter = new RecViewAdapter(SongList.this, mList);
    ...
    public void initPlay(String songName) {
        ...
        try {
            ...
            Toast.makeText(SongList.this, "下载成功", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
