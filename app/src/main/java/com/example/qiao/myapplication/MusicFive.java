...
public class MusicFive extends AppCompatActivity implements View.OnClickListener {
...
//         设置点击事件
    ...
    public void initlayout() {
        ...
        intent = new Intent(MusicFive.this, AudioService.class);
        mAdpter = new RecViewAdapter(MusicFive.this, mList);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_bottom_play:
                ...
                MusicFive.this.startService(intent);
                break;
    ...
    public void initPlay(String songName) {
        ...
        try {
            ...
            Toast.makeText(MusicFive.this, "下载成功", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
