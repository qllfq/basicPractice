...
public class MusicTwo extends AppCompatActivity implements View.OnClickListener {
...
//         设置点击事件
    ...
    public void initlayout() {
        ...
        intent = new Intent(MusicTwo.this, AudioService.class);
        mAdpter = new RecViewAdapter(MusicTwo.this, mList);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_bottom_play:
               ...
               MusicTwo.this.startService(intent);
                break;
    ...
    public void initPlay(String songName) {
        ...
        try {
            ...
            Toast.makeText(MusicTwo.this, "下载成功", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
