...
public class MusicSix extends AppCompatActivity implements View.OnClickListener {
...
//         设置点击事件
    ...
    public void initlayout() {
        ...
        intent = new Intent(MusicSix.this, AudioService.class);
        mAdpter = new RecViewAdapter(MusicSix.this, mList);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_bottom_play:
                ...
                MusicSix.this.startService(intent);
                break;
    ...
    public void initPlay(String songName) {
        ...
        try {
            ...
            Toast.makeText(MusicSix.this, "下载成功", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
