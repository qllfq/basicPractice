...
public class MusicFour extends AppCompatActivity implements View.OnClickListener {
...
//         设置点击事件
    ...
    public void initlayout() {
        ...
        intent = new Intent(MusicFour.this, AudioService.class);
        mAdpter = new RecViewAdapter(MusicFour.this, mList);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.iv_bottom_play:
                ...
                MusicFour.this.startService(intent);
                break;
    ...
    public void initPlay(String songName) {
        ...
        try {
            ...
            Toast.makeText(MusicFour.this, "下载成功", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
        }
